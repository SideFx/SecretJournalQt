/////////////////////////////////////////////////////////////////////////////
// Name:        jbtwofish.h
// Purpose:     Twofish ECB & CBC implementation (header)
// Author:      Jan Buchholz
// Created:     2026-04-03
// Changed:     2026-04-06
/////////////////////////////////////////////////////////////////////////////
...
class JBTwofish {
public:
    explicit JBTwofish(const std::vector<uint8_t>& p);
    explicit JBTwofish(const std::string& s);
    std::vector<uint8_t> encryptECB(const std::vector<uint8_t>& payload);
    std::vector<uint8_t> decryptECB(const std::vector<uint8_t>& payload);
    std::vector<uint8_t> encryptCBC(const std::vector<uint8_t>& payload, const std::vector<uint8_t>& vinit);
    std::vector<uint8_t> decryptCBC(const std::vector<uint8_t>& payload, const std::vector<uint8_t>& vinit);
    void encryptBase(std::vector<uint8_t> &p);
    void decryptBase(std::vector<uint8_t> &p);

private:
    const uint32_t RS_MOD = 0x014d;
    const uint32_t RHO = 0x01010101;
    const uint8_t TFRSARRAY[4][8] = {
        {0x01, 0xa4, 0x55, 0x87, 0x5a, 0x58, 0xdb, 0x9e,},
        {0xa4, 0x56, 0x82, 0xf3, 0x1e, 0xc6, 0x68, 0xe5,},
        {0x02, 0xa1, 0xfc, 0xc1, 0x47, 0xae, 0x3d, 0x19,},
        {0xa4, 0x55, 0x87, 0x5a, 0x58, 0xdb, 0x9e, 0x03}
    };
    const uint8_t TFQ0ARRAY[256] = {
    ...
    uint8_t tfq0array[256];
    uint8_t tfq1array[256];
    uint8_t tfq2array[256];
    uint8_t tfq3array[256];
    uint32_t tfqfarray[4][256];
    uint32_t tfs0array[4];
    uint32_t tfk0array[40];
    uint32_t polyMultiply(uint32_t a, uint32_t b) noexcept;
    uint32_t gfMod(uint32_t a, uint32_t m) noexcept;
    uint32_t gfMultiply(uint32_t a, uint32_t b, uint32_t m) noexcept;
    uint32_t rsMatrixMultiply(const uint8_t *c) noexcept;
    uint32_t gFunc(uint32_t a) noexcept;
    uint32_t hFunc(uint32_t a, const uint32_t *x) noexcept;
    void encryptRound(const uint32_t r0, const uint32_t r1, uint32_t *r2, uint32_t *r3, const uint32_t r);
    void decryptRound(const uint32_t r0, const uint32_t r1, uint32_t *r2, uint32_t *r3, const uint32_t r);
    void initialize(const std::vector<uint8_t>& p);
